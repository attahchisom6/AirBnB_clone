...
class HBNBCommand(cmd.Cmd):
    ...
    def precmd(self, arg):
        """another way to parse command to our interpreter"""
        chars = [".", "(", ")"]
        ...
        for char in chars:
            if char in arg:
                ...
                func_args = func_args_list[0]
                if classname in storage.data_classes():
                    arg = "{} {} {}".format(command, classname, func_args)
                    return (arg)
    ...
    def help_count(self):
        """help message"""
        print("Enter the count Command command to count number of \
